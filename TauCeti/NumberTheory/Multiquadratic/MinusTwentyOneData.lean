...
* `TauCeti.Multiquadratic.sqrtNegThree`: the chosen complex square root `i√3` of `-3`.
* `TauCeti.Multiquadratic.sqrtNegSeven`: the chosen complex square root `i√7` of `-7`.
-/
